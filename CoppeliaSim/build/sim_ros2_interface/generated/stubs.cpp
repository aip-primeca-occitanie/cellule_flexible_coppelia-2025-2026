...
bool registerScriptStuff()
{
    try
    {
        ...
        try
        {
            ...
            sim::registerScriptCallbackFunction("simROS2.publish@ROS2", "simROS2.publish(string publisherHandle,table message)\n\nPublish a message on the topic associated with this publisher.", publish_callback);
            ...
            sim::registerScriptCallbackFunction("simROS2.call@ROS2", "table result=simROS2.call(string clientHandle,table request)\n\nCall the service associated with this service client.", call_callback);
            ...
            sim::registerScriptCallbackFunction("simROS2.sendGoal@ROS2", "bool success=simROS2.sendGoal(string actionClientHandle,table goal)\n\nSend a goal using the specified action client.", sendGoal_callback);
            ...
            sim::registerScriptCallbackFunction("simROS2.sendTransform@ROS2", "simROS2.sendTransform(table transform)\n\nPublish a TF transformation between frames.", sendTransform_callback);
            sim::registerScriptCallbackFunction("simROS2.sendTransforms@ROS2", "simROS2.sendTransforms(table transforms)\n\nPublish several TF transformations between frames.", sendTransforms_callback);
            ...
            sim::registerScriptCallbackFunction("simROS2.getTime@ROS2", "sim_ros2_time time=simROS2.getTime(int clock_type=sim_ros2_clock_ros)\n\nReturn the current time according to the specified clock.", getTime_callback);
            ...
            sim::registerScriptCallbackFunction("simROS2.createInterface@ROS2", "table result=simROS2.createInterface(string type)\n\nConstruct an interface of the specified type, initialized with the default values.", createInterface_callback);
            sim::registerScriptCallbackFunction("simROS2.getInterfaceConstants@ROS2", "table result=simROS2.getInterfaceConstants(string type)\n\nGet an object with the constants defined in the specified interface.", getInterfaceConstants_callback);
