...
simUI.setProperties(string handle, int id, string[] pnames, string[] ptypes, string[] pvalues, int[] pflags, string[] pdisplayk, string[] pdisplayv, bool suppressEvents=true)
simUI.setPropertiesRow(string handle, int id, int row, string pname, string ptype, string pvalue, int pflags, string pdisplayk, string pdisplayv, bool suppressEvents=true)
