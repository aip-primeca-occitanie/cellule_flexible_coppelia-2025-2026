...
class Metaclass_RobotJoints(type):
    """Metaclass of message 'RobotJoints'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'commande_locale.msg.RobotJoints')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__robot_joints
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__robot_joints
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__robot_joints
            cls._TYPE_SUPPORT = module.type_support_msg__msg__robot_joints
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__robot_joints
...
class RobotJoints(metaclass=Metaclass_RobotJoints):
    """Message class 'RobotJoints'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.joint7 = kwargs.get('joint7', int())
    ...
    def joint6(self, value):
        if self._check_fields:
            ...
            assert value >= -2147483648 and value < 2147483648, \
                "The 'joint6' field must be an integer in [-2147483648, 2147483647]"
        self._joint6 = value
    ...
    def joint7(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'joint7' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'joint7' field must be an integer in [-2147483648, 2147483647]"
        self._joint7 = value
