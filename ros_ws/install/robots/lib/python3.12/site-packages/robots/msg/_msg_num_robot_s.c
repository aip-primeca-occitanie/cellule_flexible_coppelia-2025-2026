...
bool robots__msg__msg_num_robot__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robots.msg._msg_num_robot.MsgNumRobot", full_classname_dest, 37) == 0);
  }
  robots__msg__MsgNumRobot * ros_message = _ros_message;
  {  // num_robot
...
{
  /* NOTE(esteve): Call constructor of MsgNumRobot */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robots.msg._msg_num_robot");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MsgNumRobot");
