...
class MoveRobot(metaclass=Metaclass_MoveRobot):
    ...
    def __init__(self, **kwargs):
        ...
        self.bras = kwargs.get('bras', int())
        self.pince = kwargs.get('pince', int())
    ...
    def __eq__(self, other):
        ...
        if self.position != other.position:
            return False
        if self.bras != other.bras:
            return False
        if self.pince != other.pince:
            return False
    ...
    def bras(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'bras' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'bras' field must be an integer in [-2147483648, 2147483647]"
        self._bras = value
    ...
    @pince.setter
    def pince(self, value):
        if self._check_fields:
            assert \
                isinstance(value, int), \
                "The 'pince' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'pince' field must be an integer in [-2147483648, 2147483647]"
        self._pince = value
