...
{
  new (message_memory) shuttles::msg::MsgErreur(_init);
}

void MsgErreur_fini_function(void * message_memory)
{
  auto typed_message = static_cast<shuttles::msg::MsgErreur *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MsgErreur_message_member_array[2] = {
  {
    ...
    offsetof(shuttles::msg::MsgErreur, code),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shuttles::msg::MsgErreur, n_poste),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::shuttles::msg::rosidl_typesupport_introspection_cpp::MsgErreur_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, shuttles, msg, MsgErreur)() {
  return &::shuttles::msg::rosidl_typesupport_introspection_cpp::MsgErreur_message_type_support_handle;
}
