...
static const _MoveRobot_type_support_symbol_names_t _MoveRobot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robots, msg, MoveRobot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robots, msg, MoveRobot)),
  }
};
...
{
  return &::robots::msg::rosidl_typesupport_cpp::MoveRobot_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robots, msg, MoveRobot)() {
  return get_message_type_support_handle<robots::msg::MoveRobot>();
}
