...
static const _MoveRobot_type_support_symbol_names_t _MoveRobot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robots, msg, MoveRobot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robots, msg, MoveRobot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robots, msg, MoveRobot)() {
  return &::robots::msg::rosidl_typesupport_c::MoveRobot_message_type_support_handle;
}
