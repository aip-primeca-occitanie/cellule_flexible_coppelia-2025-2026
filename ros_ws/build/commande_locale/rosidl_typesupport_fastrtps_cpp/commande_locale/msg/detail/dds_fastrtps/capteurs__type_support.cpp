...
#include "commande_locale/msg/detail/capteurs__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const commande_locale::msg::Capteurs & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  commande_locale::msg::Capteurs & ros_message)
{
  // Member: capteurs
  cdr >> ros_message.capteurs;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = commande_locale::msg::Capteurs;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const commande_locale::msg::Capteurs *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<commande_locale::msg::Capteurs *>(
    untyped_ros_message);
...
{
  return &commande_locale::msg::typesupport_fastrtps_cpp::_Capteurs__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, commande_locale, msg, Capteurs)() {
  return &commande_locale::msg::typesupport_fastrtps_cpp::_Capteurs__handle;
}
