...
#include "commande_locale/msg/detail/msg_add_product__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const commande_locale::msg::MsgAddProduct & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  commande_locale::msg::MsgAddProduct & ros_message)
{
  // Member: num_poste
  cdr >> ros_message.num_poste;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_commande_locale
max_serialized_size_MsgAddProduct(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = commande_locale::msg::MsgAddProduct;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_commande_locale
max_serialized_size_key_MsgAddProduct(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const commande_locale::msg::MsgAddProduct *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<commande_locale::msg::MsgAddProduct *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MsgAddProduct__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const commande_locale::msg::MsgAddProduct *>(
...
static size_t _MsgAddProduct__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MsgAddProduct(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MsgAddProduct__callbacks = {
  "commande_locale::msg",
  "MsgAddProduct",
...
static rosidl_message_type_support_t _MsgAddProduct__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MsgAddProduct__callbacks,
...
{
  return &commande_locale::msg::typesupport_fastrtps_cpp::_MsgAddProduct__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, commande_locale, msg, MsgAddProduct)() {
  return &commande_locale::msg::typesupport_fastrtps_cpp::_MsgAddProduct__handle;
}
