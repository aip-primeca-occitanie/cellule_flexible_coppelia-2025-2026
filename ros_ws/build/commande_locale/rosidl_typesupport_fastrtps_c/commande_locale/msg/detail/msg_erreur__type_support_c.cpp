...
#include "commande_locale/msg/detail/msg_erreur__rosidl_typesupport_fastrtps_c.h"
...
using _MsgErreur__ros_msg_type = commande_locale__msg__MsgErreur;
...
{
  const _MsgErreur__ros_msg_type * ros_message = static_cast<const _MsgErreur__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = commande_locale__msg__MsgErreur;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const commande_locale__msg__MsgErreur * ros_message = static_cast<const commande_locale__msg__MsgErreur *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_commande_locale__msg__MsgErreur(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  commande_locale__msg__MsgErreur * ros_message = static_cast<commande_locale__msg__MsgErreur *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_commande_locale__msg__MsgErreur(cdr, ros_message);
}

static uint32_t _MsgErreur__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_commande_locale__msg__MsgErreur(
...
static size_t _MsgErreur__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_commande_locale__msg__MsgErreur(
...
static message_type_support_callbacks_t __callbacks_MsgErreur = {
  "commande_locale::msg",
  "MsgErreur",
...
static rosidl_message_type_support_t _MsgErreur__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MsgErreur,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, commande_locale, msg, MsgErreur)() {
  return &_MsgErreur__type_support;
}
