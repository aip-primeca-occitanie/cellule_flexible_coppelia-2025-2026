...
bool commande_locale__msg__msg_erreur__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("commande_locale.msg._msg_erreur.MsgErreur", full_classname_dest, 41) == 0);
  }
  commande_locale__msg__MsgErreur * ros_message = _ros_message;
  {  // code
...
PyObject * commande_locale__msg__msg_erreur__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("commande_locale.msg._msg_erreur");
