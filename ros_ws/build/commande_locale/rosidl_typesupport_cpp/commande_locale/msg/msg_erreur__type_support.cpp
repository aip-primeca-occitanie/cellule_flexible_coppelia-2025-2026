...
static const _MsgErreur_type_support_symbol_names_t _MsgErreur_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, commande_locale, msg, MsgErreur)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, commande_locale, msg, MsgErreur)),
  }
};
...
{
  return &::commande_locale::msg::rosidl_typesupport_cpp::MsgErreur_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, commande_locale, msg, MsgErreur)() {
  return get_message_type_support_handle<commande_locale::msg::MsgErreur>();
}
