...
static const _Capteurs_type_support_symbol_names_t _Capteurs_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, commande_locale, msg, Capteurs)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, commande_locale, msg, Capteurs)),
  }
};
...
get_message_type_support_handle<commande_locale::msg::Capteurs>()
{
  return &::commande_locale::msg::rosidl_typesupport_cpp::Capteurs_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, commande_locale, msg, Capteurs)() {
  return get_message_type_support_handle<commande_locale::msg::Capteurs>();
}
