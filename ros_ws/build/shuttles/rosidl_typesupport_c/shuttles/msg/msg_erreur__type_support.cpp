...
static const _MsgErreur_type_support_symbol_names_t _MsgErreur_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, shuttles, msg, MsgErreur)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, shuttles, msg, MsgErreur)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, shuttles, msg, MsgErreur)() {
  return &::shuttles::msg::rosidl_typesupport_c::MsgErreur_message_type_support_handle;
}
