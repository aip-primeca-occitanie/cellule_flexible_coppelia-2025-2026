...
#include "shuttles/msg/detail/msg_erreur__rosidl_typesupport_fastrtps_c.h"
...
using _MsgErreur__ros_msg_type = shuttles__msg__MsgErreur;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = shuttles__msg__MsgErreur;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const shuttles__msg__MsgErreur * ros_message = static_cast<const shuttles__msg__MsgErreur *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_shuttles__msg__MsgErreur(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  shuttles__msg__MsgErreur * ros_message = static_cast<shuttles__msg__MsgErreur *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_shuttles__msg__MsgErreur(cdr, ros_message);
}

static uint32_t _MsgErreur__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_shuttles__msg__MsgErreur(
...
static size_t _MsgErreur__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_shuttles__msg__MsgErreur(
