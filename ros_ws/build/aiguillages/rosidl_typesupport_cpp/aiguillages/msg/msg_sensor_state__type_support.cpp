...
static const _MsgSensorState_type_support_symbol_names_t _MsgSensorState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aiguillages, msg, MsgSensorState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, aiguillages, msg, MsgSensorState)),
  }
};
...
{
  return &::aiguillages::msg::rosidl_typesupport_cpp::MsgSensorState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, aiguillages, msg, MsgSensorState)() {
  return get_message_type_support_handle<aiguillages::msg::MsgSensorState>();
}
