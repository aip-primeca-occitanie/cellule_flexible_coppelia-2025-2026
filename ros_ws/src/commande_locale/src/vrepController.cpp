...
void vrepController::init(rclcpp::Node::SharedPtr n, const string& executionPath, const string& simulationFileName)
{
    ...
    pubSim_startSimulation = node->create_publisher<std_msgs::msg::Byte>(
        "/sim_ros_interface/services/vrep_controller/StartSimulation", 100);
    subSim_startSimulation = node->create_subscription<std_msgs::msg::Byte>(
        "/sim_ros_interface/services/response/vrep_controller/StartSimulation", 100,
        std::bind(&vrepController::simStartSimulationCallback, this, std::placeholders::_1)
    );

    pubSim_pauseSimulation = node->create_publisher<std_msgs::msg::Byte>(
        "/sim_ros_interface/services/vrep_controller/PauseSimulation", 100);
    subSim_pauseSimulation = node->create_subscription<std_msgs::msg::Byte>(
        "/sim_ros_interface/services/response/vrep_controller/PauseSimulation", 100,
        std::bind(&vrepController::simPauseSimulationCallback, this, std::placeholders::_1)
    );

    pubSim_loadModel = node->create_publisher<std_msgs::msg::String>(
        "/sim_ros_interface/services/vrep_controller/LoadModel", 100);
    subSim_loadModel = node->create_subscription<std_msgs::msg::Int32>(
        "/sim_ros_interface/services/response/vrep_controller/LoadModel", 100,
        std::bind(&vrepController::simLoadModelCallback, this, std::placeholders::_1)
    );

    pubSim_changeColor = node->create_publisher<std_msgs::msg::Int32MultiArray>(
        "/sim_ros_interface/services/vrep_controller/ChangeColor", 100);
    subSim_changeColor = node->create_subscription<std_msgs::msg::Byte>(
        "/sim_ros_interface/services/response/vrep_controller/ChangeColor", 100,
        std::bind(&vrepController::simChangeColorCallback, this, std::placeholders::_1)
    );

    pubSim_getColor = node->create_publisher<std_msgs::msg::String>(
        "/sim_ros_interface/services/vrep_controller/GetColor", 100);
    subSim_getColor = node->create_subscription<std_msgs::msg::Int32>(
        "/sim_ros_interface/services/response/vrep_controller/GetColor", 100,
        std::bind(&vrepController::simGetColorCallback, this, std::placeholders::_1)
    );

    pubStopTacheRobot1 = node->create_publisher<std_msgs::msg::Int32>(
        "/commande/Simulation/Robot1/StopTache", 100);
    pubStopTacheRobot2 = node->create_publisher<std_msgs::msg::Int32>(
        "/commande/Simulation/Robot2/StopTache", 100);
    pubStopTacheRobot3 = node->create_publisher<std_msgs::msg::Int32>(
        "/commande/Simulation/Robot3/StopTache", 100);
    pubStopTacheRobot4 = node->create_publisher<std_msgs::msg::Int32>(
        "/commande/Simulation/Robot4/StopTache", 100);

    pub_erreur_log = node->create_publisher<commande_locale::msg::MsgErreur>(
        "/commande/Simulation/Erreur_log", 100);
