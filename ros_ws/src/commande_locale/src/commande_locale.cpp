...
// --- Callbacks ---
bool AddProduct(
    const std::shared_ptr<commande_locale::srv::SrvAddProduct::Request> req,
    std::shared_ptr<commande_locale::srv::SrvAddProduct::Response> res)
{
...
void FinInitCallback(
    const std::shared_ptr<commande_locale::srv::SrvFinInit::Request>,
    std::shared_ptr<commande_locale::srv::SrvFinInit::Response>)
{
    initEnCours = false;
}
