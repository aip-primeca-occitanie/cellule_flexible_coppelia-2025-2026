...
{
	sub_capteurs_simu = node->create_subscription<aiguillages::msg::MsgSensorState>("/commande/Simulation/Capteurs", 100, std::bind(&Capteurs::Callback_capteurs_simulation, this, std::placeholders::_1));
