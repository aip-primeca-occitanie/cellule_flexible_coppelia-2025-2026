...
if (sim_call_type==sim.syscb_init) then
    ...
    if simROS2 then
        -- 3. Création sécurisée avec pcall
        -- Topic: /sim_ros_interface/SwitchSensor (Note: vérifie si tu veux changer le nom du topic pour StationSensor ?)
        local status, createdPub = pcall(simROS2.createPublisher, '/sim_ros_interface/SwitchSensor', 'std_msgs/msg/Int32')
