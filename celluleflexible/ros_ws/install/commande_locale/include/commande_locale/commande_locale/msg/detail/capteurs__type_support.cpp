...
{
  new (message_memory) commande_locale::msg::Capteurs(_init);
}

void Capteurs_fini_function(void * message_memory)
{
  auto typed_message = static_cast<commande_locale::msg::Capteurs *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Capteurs_message_member_array[1] = {
  {
    ...
    offsetof(commande_locale::msg::Capteurs, capteurs),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Capteurs_message_members = {
  ...
  1,  // number of fields
  sizeof(commande_locale::msg::Capteurs),
...
{
  return &::commande_locale::msg::rosidl_typesupport_introspection_cpp::Capteurs_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, commande_locale, msg, Capteurs)() {
  return &::commande_locale::msg::rosidl_typesupport_introspection_cpp::Capteurs_message_type_support_handle;
}
