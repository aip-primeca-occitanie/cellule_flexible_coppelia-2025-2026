...
Actionneurs::Actionneurs(rclcpp::Node::SharedPtr node)
{
	// Publisher
	pub_actionneurs_ligne = node->create_publisher<commande_locale::msg::Actionneurs>("/commande/Ligne_transitique/Actionneurs", 100);
	pub_actionneurs_simu_aguillages = node->create_publisher<commande_locale::msg::MsgSwitchControl>("/commande/Simulation/Actionneurs_aiguillages", 100);
...
{
	commande_locale::msg::Actionneurs msg;
