...
if (sim_call_type==sim.syscb_init) then
    ...
    local status, h = pcall(sim.getObjectHandle, 'RG2_openCloseJoint#2')
    ...
    if simROS2 then
        ...
        simROS2.createSubscription('/robot/cmdPinceRobot4', 'std_msgs/msg/Int32', 'cmdPinceRobotCallback')
        --print("Pince RG2 : Abonné au topic /robot/cmdPinceRobot2")
    else
