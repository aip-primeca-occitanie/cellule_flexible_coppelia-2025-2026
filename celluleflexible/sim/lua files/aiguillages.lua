...
-- on met rien comme dans la premier version, version codé dans une version préliminaire pour  lire la position réelle des aiguillages et l'envoyer à ROS 2 sur le topic SwitchSensor et communiquer avec notre noeud pas sur que ca serve pour la suite, à voir
end
